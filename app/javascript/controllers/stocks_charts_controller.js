      ...
      options: {
        ...
        plugins: {
          ...
          datalabels: {
            ...
            display: (context) => { const v = parseFloat(context.dataset.data[context.dataIndex]); return !isNaN(v) && v >= 5 },
            formatter: (value) => { const v = parseFloat(value); return `${v.toFixed(1)}%` },
            anchor: "center",
            align: "center"
          }
        }
