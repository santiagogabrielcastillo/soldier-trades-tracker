...
class Trades::IndexServiceTest < ActiveSupport::TestCase
  ...
  test "history with exchange_account_id filters to that account's trades" do
    ...
    Trade.create!(exchange_account: @account, exchange_reference_id: "h1", symbol: "BTC-USDT", side: "buy", fee: 0, net_amount: -100, executed_at: Time.current, raw_payload: {})
    ...
    Trade.create!(exchange_account: other, exchange_reference_id: "h2", symbol: "ETH-USDT", side: "buy", fee: 0, net_amount: -50, executed_at: Time.current, raw_payload: {})
  ...
  test "exchange view with from_date filters trades" do
    Trade.where(exchange_account: @account).delete_all
    Trade.create!(exchange_account: @account, exchange_reference_id: "e1", symbol: "BTC-USDT", side: "buy", fee: 0, net_amount: -100, executed_at: 5.days.ago, raw_payload: {})
  ...
  test "portfolio with exchange_account_id scopes to that account" do
    Trade.where(exchange_account: @account).delete_all
    Trade.create!(exchange_account: @account, exchange_reference_id: "p1", symbol: "BTC-USDT", side: "buy", fee: 0, net_amount: -100, executed_at: Time.current, raw_payload: {})
